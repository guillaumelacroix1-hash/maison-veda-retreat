        ...
        <>
            ...
            <Section>
                <div className="grid gap-14 lg:grid-cols-2 lg:gap-20">
                    ...
                    <div>
                        <h2 className="font-heading text-3xl md:text-4xl">{t('contact.addressTitle')}</h2>
                        <ul className="mt-9 space-y-6 text-base font-light text-veda-light/70">
                            <li className="flex items-start gap-4">
                                ...
                                {lang === 'en' ? CONTACT.addressEn : CONTACT.addressFr}
                            </li>
                            <li className="flex items-center gap-4">
                                <Phone className="h-5 w-5 shrink-0 text-veda-gold" />
