...
export const SRILANKA = {
    fr: {
        ...
        prices: {
            ...
            /**
             * Les montants ci-dessus — 70, 100 et 200 € — sont confirmés par
             * Aurélie le 29/08/2026 comme étant ceux de la haute saison. La
             * basse saison ne s'affiche pas : elle se donne sur demande.
             */
        ...
        story: {
            ...
            // Récit court, écrit avec Aurélie le 18/09/2026 à partir de sa présentation
            ...
            paragraphs: [
                ...
                'En Inde, je me suis formée à l\'ayurvéda, et j\'ai appris à écouter mon corps. J\'y ai compris qu\'apaiser un symptôme ne suffit pas : il faut chercher la source.',
                'Puis le yoga m\'a ramenée à la vie… Mais c\'est le Kundalini qui a transformé mon mental, ma vision et ma conscience. Il a réaligné mon système nerveux, nettoyé mon subconscient… et réveillé en moi une joie que je ne connaissais plus.',
    ...
    en: {
        ...
        story: {
            title: 'Our Story',
            // Présentation écrite en anglais par Aurélie le 18/09/2026, complétée avec
            // elle du Kundalini, du chant, de la ferme et du lac, comme le français.
            ...
            paragraphs: [
                ...
                'Then yoga brought me back to life… But it was Kundalini Yoga that reshaped my mind, my vision, and my awareness. It realigned my nervous system, cleansed my subconscious… and awakened a joy in me I no longer knew.',
