 ...
 *
 * La grille ci-dessous, dictée par Aurélie le 30/08/2026 : deux cours par jour
 * du lundi au samedi, un avec Lilie et un avec Anna. Les cours de pleine
 * saison (`seasonal`) s'y ajoutent sans les remplacer.
 */
