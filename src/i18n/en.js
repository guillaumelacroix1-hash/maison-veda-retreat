...
export default {
    ...
    home: {
        ...
        reviewLead: 'Have you stayed with us?',
        reviewCta: 'Leave a review',
        instagramLead: 'Daily life at La maison VEDA, in pictures:',
    ...
    retreats: {
        ...
        depositTerms: 'The deposit is non-refundable, unless your place is taken by someone else, or in a case of force majeure — a pandemic, air travel shutting down.',
        programme: 'Programme',
        place: 'The place',
        guides: 'Your guides',
    ...
    host: {
        ...
        simBoard: 'Full board',
        simBoardNote: '{prix} per person per day, three vegetarian meals. Meals for 1 to 2 organisers are on us. Untick if your group brings its own chef.',
        simBedsShort: '{n} bed(s) short: {places} places booked for {monde} people. Add a chalet or a room at our partners.',
        ...
        roomsText: 'There are no single rooms at La maison VEDA. The beds are spread across the two villas: at the Lake Loft, a large air-conditioned apartment with a fitted kitchen and a broad terrace onto the tropical garden, three sleeping areas set apart by wide curtains; at the Lake House, a traditional earth-walled house, two connecting rooms at the water\'s edge. Everyone has their own bed and their own space, in a comfortable place kept with care.',
        ...
        packContentsTitle: 'What\'s inside',
        packContents: [
            'The place at a glance',
            'The "La maison VEDA" base',
    ...
    studio: {
        ...
        scheduleNote: 'Kundalini is our heart practice: it opens every day, six days a week. Around it come mantras, breathwork, kirtans and gong baths. The schedule is updated every week, here and on Instagram. The season starts gently in November, fills out from December to February, and eases off again in April.',
        ...
        cafeTitle: 'And after class,', cafeAccent: 'coffee, breakfast in the garden?',
