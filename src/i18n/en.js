...
export default {
    ...
    host: {
        ...
        simPerNight: 'night', simPerTrip: 'trip', simPerPerson: 'person', simPerGroup: 'session',
        simTransfers: 'Airport transfers',
        simTransfersNote: 'Price per one-way trip — count two for a return.',
        simExperiences: 'À la carte experiences',
        simExperiencesNote: 'Indicative rates, confirmed with the practitioner when you book.',
        ...
        simBedsShort: '{n} bed(s) short: you have {total} places for your group. Add a chalet or a room at our partners.',
