...
export default {
    ...
    host: {
        ...
        simPerNight: 'nuit', simPerTrip: 'trajet', simPerPerson: 'personne', simPerGroup: 'séance',
        simTransfers: 'Transferts aéroport',
        simTransfersNote: 'Prix par trajet simple — comptez-en deux pour un aller-retour.',
        simExperiences: 'Expériences à la carte',
        simExperiencesNote: 'Tarifs indicatifs, confirmés avec l\'intervenant au moment de la réservation.',
        ...
        simBedsShort: 'Il manque {n} couchage(s) : vous avez {total} places pour votre groupe. Ajoutez un chalet ou une chambre chez nos partenaires.',
