...
export default {
    ...
    home: {
        ...
        reviewLead: 'Vous avez séjourné chez nous ?',
        reviewCta: 'Laisser un avis',
        instagramLead: 'Les journées à La Maison VEDA, en images :',
    ...
    host: {
        ...
        simBoardNote: '{prix} par personne et par jour, trois repas végétariens. Les repas de 1 à 2 organisateurs sont offerts. Décochez si votre groupe vient avec son propre chef.',
        simBedsShort: 'Il manque {n} couchage(s) : {places} places réservées pour {monde} personnes. Ajoutez un chalet ou une chambre chez nos partenaires.',
        ...
        // Sommaire repris des titres de nouveau-site/info-pack-organisateurs.md,
        // la source du PDF : à tenir à jour si le pack change de plan.
        packContentsTitle: 'Au sommaire',
        packContents: [
            'Le lieu en un coup d\'œil',
            'La base « La Maison VEDA »',
            'Les hébergements partenaires',
            'La table',
            'Les expériences à la carte',
            'Les tarifs',
            'Les conditions de réservation',
            'L\'organisation, ensemble',
            'Les disponibilités et le contact',
        ],
    ...
    studio: {
        ...
        classesFacts: [
            { label: 'Durée', value: '1 h 30', detail: 'Pour un cours de Kundalini. Les autres pratiques ont leur propre durée : les horaires sont au planning.' },
            { label: 'Matériel', value: 'Fourni', detail: 'Tapis et blocs vous attendent sur le shala.' },
            { label: 'Niveau', value: 'Tous', detail: 'Aucune pratique préalable n\'est demandée.' },
        ],
        classesFlowTitle: 'Le déroulé',
        classesFlow: [
            'On se connecte à soi, avec un mantra et un échauffement.',
            'Puis vient le kriya : un ensemble de postures.',
            'On termine par une méditation et une relaxation.',
        ],
        classesLevelParagraphs: [
            'Tout le monde peut suivre un cours de Kundalini. Le rythme et les temps de pause s\'adaptent à chacun : vous pouvez ralentir, et faire autant de pauses que vous le souhaitez. On vous pousse à vous dépasser, mais c\'est vous qui savez où est votre limite et quand vous arrêter.',
            'L\'intensité varie beaucoup d\'un cours à l\'autre, selon le kriya pratiqué : certains sont doux et méditatifs, d\'autres franchement sportifs. Dans tous les cas, l\'alternance entre l\'effort et le repos est là pour équilibrer le système nerveux.',
        ],
        classesBooking: 'Mieux vaut réserver : un message WhatsApp à Lilie ou à Anna suffit.',
        classesBookLilie: 'Écrire à Lilie',
        classesBookAnna: 'Écrire à Anna',
        ...
        philosophyEyebrow: 'Notre pratique',
        philosophyTitle: 'Le Kundalini Yoga', philosophyAccent: 'selon Yogi Bhajan',
        philosophyParagraphs: [
            'Anna et moi enseignons le Kundalini Yoga tel que l\'a transmis Yogi Bhajan — une pratique qui a changé nos vies à toutes les deux. Pour nous, ce n\'est pas un yoga parmi d\'autres : c\'est un chemin de transformation, où le souffle, le mouvement et le son se rejoignent pour éveiller l\'énergie qui sommeille en chacun.',
        ...
        agendaRetreatCta: 'Voir la retraite',
