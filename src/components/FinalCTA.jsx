            ...
            <div className="max-w-6xl mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    >
                        ...
                        <div className="pt-8">
                            <button className="group inline-flex items-center justify-center px-8 py-4 text-sm font-bold tracking-widest text-veda-dark uppercase bg-veda-gold rounded-full transition-all duration-300 hover:bg-white hover:text-veda-dark shadow-lg hover:shadow-xl hover:-translate-y-1">
